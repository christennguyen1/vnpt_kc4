...
if (data && data.length) {
  ...
  if (selectedSensor) {
    ...
    noAqiValue = processValue(entity['NO_24h'], 3);
    ...
    noAqi24Value = processValue(entity['NO_24h'], 3);
    ...
    pm25Aqi48Value = processValue(entity['PM25_48h'], 3);
    pm10Aqi48Value = processValue(entity['PM10_48h'], 3);
    noAqi48Value = processValue(entity['NO_48h'], 3);
    ...
    noAqi72Value = processValue(entity['NO_72h'], 3);



    Aqi24hValue = processValue(entity['aqi_24h'], 3);
    Aqi48hValue = processValue(entity['aqi_48h'], 3);
    Aqi72hValue = processValue(entity['aqi_72h'], 3);
...
const aqiComponents24ForeCastSection = (!selectedSensor ? '' :
  ...
  '<mat-button-toggle id="pm25" class="aqi-component flex-full" style="margin-right:6px; max-width:calc(33.33% - 6px);">' +
  '<div class="aqi-component-content flex flex-col items-start justify-between">' +
  '<div class="aqi-component-name" style="line-height:25px">AQI</div>' +
  '<div class="aqi-component-value">'+ Aqi24hValue +'</div>' +
  '<div class="aqi-component-bar">' +
  '<div class="aqi-component-bar-value" style="background-color:'+ getAqiColor(Aqi24hValue) + ';width:' + getAqiComponentBarWidth(Aqi24hValue) +'%"></div>' +
  '</div>' +
  '</div>' +
  '</mat-button-toggle>' +
  '<mat-button-toggle id="pm10" class="aqi-component flex-full" style="margin-left:3px;margin-right:3px;max-width:calc(33.33% - 6px);">' +
...
const aqiComponents48ForeCastSection = (!selectedSensor ? '' :
  ...
  '<div class="aqi-component-content flex flex-col items-start justify-between">' +
  '<div class="aqi-component-name" style="line-height:25px">AQI</div>' +
  '<div class="aqi-component-value">'+ Aqi48hValue +'</div>' +
  '<div class="aqi-component-bar">' +
  '<div class="aqi-component-bar-value" style="background-color:'+ getAqiColor(Aqi48hValue) + ';width:' + getAqiComponentBarWidth(Aqi48hValue) +'%"></div>' +
  '</div>' +
  '</div>' +
  '</mat-button-toggle>' +
  '<mat-button-toggle id="pm10" class="aqi-component flex-full" style="margin-left:3px;margin-right:3px;max-width:calc(33.33% - 6px);">' +
  '<div class="aqi-component-content flex flex-col items-start justify-between">' +
  '<div class="aqi-component-name" style="line-height:25px">PM2.5</div>' +
  '<div class="aqi-component-value">'+ pm25Aqi48Value +'</div>' +
  '<div class="aqi-component-bar">' +
  '<div class="aqi-component-bar-value" style="background-color:'+ getAqiColor(pm25Aqi48Value) + ';width:' + getAqiComponentBarWidth(pm25Aqi48Value) +'%"></div>' +
  '</div>' +
  '</div>' +
  '</mat-button-toggle>' +
  '<mat-button-toggle id="pm10" class="aqi-component flex-full" style="margin-left:3px;margin-right:3px;max-width:calc(33.33% - 6px);">' +
  '<div class="aqi-component-content flex flex-col items-start justify-between">' +
  '<div class="aqi-component-name" style="line-height:25px">PM10</div>' +
  '<div class="aqi-component-value">'+ pm10Aqi48Value +'</div>' +
  '<div class="aqi-component-bar">' +
  '<div class="aqi-component-bar-value" style="background-color:'+ getAqiColor(pm10Aqi48Value) + ';width:' + getAqiComponentBarWidth(pm10Aqi48Value) +'%"></div>' +
  '</div>' +
  '</div>' +
  '</mat-button-toggle>' +
  '<mat-button-toggle id="no2" class="aqi-component flex-full" style="margin-left:6px;max-width:calc(33.33% - 6px);">'+
...
const aqiComponents72ForeCastSection = (!selectedSensor ? '' :
  ...
  '<div class="aqi-component-content flex flex-col items-start justify-between">' +
  '<div class="aqi-component-name" style="line-height:25px">AQI</div>' +
  '<div class="aqi-component-value">'+ Aqi72hValue +'</div>' +
  '<div class="aqi-component-bar">' +
  '<div class="aqi-component-bar-value" style="background-color:'+ getAqiColor(Aqi72hValue) + ';width:' + getAqiComponentBarWidth(Aqi72hValue) +'%"></div>' +
  '</div>' +
  '</div>' +
  '</mat-button-toggle>' +
  '<mat-button-toggle id="pm10" class="aqi-component flex-full" style="margin-left:3px;margin-right:3px;max-width:calc(33.33% - 6px);">' +
